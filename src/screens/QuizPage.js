        ...
        <View style={styles.container}>
            ...
            <View style={styles.questionContainer}>
                <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginRight: 10, marginTop: 10 }}>
                    ...
                    <View style={{ borderColor: 'red', height: hp('3%'), width: 50, borderWidth: 2, borderRadius: 5 }}>
                        <Text style={{ ...styles.textStyle, color: 'red', marginLeft: 2 }}>10:00</Text>
                    </View>
                </View>
                <View style={{ marginTop: hp('2.5%') }}>
                    <Text style={styles.questionTextStyle}>Q1. FIND OUT THE FIGURE OF SPEECH IN THE FOLLOWING SENTENCE: “AS BUSY AS A BEE”
                    </Text>
                </View>
                <View style={{ marginLeft: wp('4%'), marginTop: hp('2.5%') }}>
                    ...
                    <View style={{ marginLeft: wp('10%'), marginTop: hp('1.5%') }}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={{ ...styles.textStyle, marginLeft: wp('7%') }}>SIMILE</Text>
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 7 }}>
                            <Text style={styles.textStyle}>b.</Text>
                            <Text style={{ ...styles.textStyle, marginLeft: wp('7%') }}>METAPHOR</Text>
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 7 }}>
                            <Text style={styles.textStyle}>c.</Text>
                            <Text style={{ ...styles.textStyle, marginLeft: wp('7%') }}>ALLITERATION</Text>
                        </View>
                        <View style={{ flexDirection: 'row', marginTop: 7 }}>
                            <Text style={styles.textStyle}>d.</Text>
                            <Text style={{ ...styles.textStyle, marginLeft: wp('7%') }}>INTERROGATION</Text>
                        </View>
                    </View>
                </View>
            </View>
